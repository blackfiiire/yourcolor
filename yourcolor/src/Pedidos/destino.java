...
public class destino extends javax.swing.JDialog {
    ...
    public destino(java.awt.Frame parent, boolean modal) {
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("SELECT ventas.numero,ventas.fecha, ventas.rut_clien, ventas.Total, estados.descripcion,usuarios.nombres FROM usuarios,ventas,estados WHERE (usuarios.rut=ventas.rut_clien) and (ventas.estado=estados.id) and (estados.descripcion='En Destino')");
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
            ...
            
        {
            int va1= Integer.parseInt(tabla1.getValueAt(fila, 0).toString());
                       statement.execute("UPDATE ventas SET estado = '4' WHERE numero = '"+va1+"'");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                destino dialog = new destino(new javax.swing.JFrame(), true);
