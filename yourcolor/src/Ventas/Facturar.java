...
Connection cn = conexion.conectar();
    ...
    private void initComponents() {
        ...
        Vuelto.setFont(new java.awt.Font("Impact", 1, 24)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            String Emple = "0";
            //armar query
            String Query = "INSERT INTO ventas (numero, fecha, rut_emple, rut_clien, Total, estado, Pago) VALUES (" + n + ",'" + variables.Fecha + "'," + variables.Rut + "," + Emple + "," + TotalV + ")";
            //ejecutar query
